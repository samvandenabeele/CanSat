...
class BMP280:
    ...
    def _read_compensation_parameters(self):
        rxdata = self._read(0x88, 24) # type: ignore
    ...
    def reset(self):
        self._write(0xe0, bytearray(b'\xb6')) # type: ignore
    ...
    def chip_id(self) -> str:
        ...
        """
        rxdata = self._read(0xd0, 1) # type: ignore
        return hex(rxdata[0])
    ...
    def status(self):
        ...
        """
        rxdata = self._read(0xf3, 1) # type: ignore
        return hex(rxdata[0])
    ...
    def config(self):
        ...
        """
        rxdata = self._read(0xf5, 1) # type: ignore
        return hex(rxdata[0])
    
    def _write_config(self):
        self._write(0xf5, self._configuration.config) # type: ignore
    ...
    def ctrl_meas(self):
        ...
        the chip.
        """
        rxdata = self._read(0xf4, 1) # type: ignore
        return hex(rxdata[0])
    
    def _write_ctrl_meas(self):
        self._write(0xf4, self._configuration.ctrl_meas) # type: ignore
    ...
    def measurements(self) -> dict:
        ...
        rxdata = self._read(0xf7, 6) # type: ignore
